...
export const ComparisonSection: React.FC = () => {
  ...
  const options: CompareOption[] = [
    ...
    {
      id: 'gummy',
      tabLabel: 'Желираните витамини',
      emoji: '🧸',
      title: 'Шарените желирани мечета и витамини',
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-3xl p-6 md:p-8 border border-amber-200/60 mb-12 text-center shadow-sm">
          ...
          <p className="text-slate-700 text-sm md:text-base leading-relaxed max-w-2xl mx-auto">
            Да, желираните витамини са лесни. Но замисляте ли се как работи това вътре в организма на детето? Всеки желиран витамин преминава химично желиране, което вместо истински имунитет, <strong className="text-amber-800">натоварва и задръства нежния детски организъм с лепила, захари и химия.</strong>
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center bg-gradient-to-br from-emerald-800 via-emerald-900 to-emerald-950 rounded-3xl p-6 md:p-8 text-white relative shadow-lg">
          ...
          <div className="md:col-span-7 space-y-4">
            ...
            <p className="text-emerald-100/90 text-sm leading-relaxed">
              Няма дете, което да изпие дори една чаша сутрин. Naturino Kids капките са точно това – <strong className="text-amber-300">мощен органичен концентрат</strong>. Един прием дава сила, все едно малчуганът е изпил 3 литра чист, топъл билков чай наведнъж!
            </p>
          </div>
