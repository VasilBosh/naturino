        ...
        <div className="text-center max-w-4xl mx-auto mb-10 md:mb-16">
          ...
          <h2 className="reveal opacity-0 text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-emerald-800 mb-4 md:mb-6">
            ...
            <span className="gradient-text">
              е по-различен от масовите продукти на пазара?
            </span>
          </h2>
                ...
                <div className="rounded-2xl bg-amber-50 border border-amber-100 p-4 md:p-5">
                  ...
                  <p className="text-[15px] md:text-base leading-7 text-slate-700">
                    ...
                    <strong className="text-amber-700">
                      {' '}Планински лимон (Chaenomeles maulei)
                    </strong>{' '}
                    — плод, съдържащ до <strong>5 пъти повече витамин C</strong> от
                    обикновения лимон и до <strong>10 пъти повече витамин P</strong> от ябълките.
                  </p>
            ...
            <div className="bg-amber-50 border-l-4 border-amber-400 p-4 md:p-5 rounded-r-xl mb-6">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                ...
                <p className="text-slate-800 text-sm md:text-base leading-relaxed">
                  ...
                  <strong>Важно:</strong> Продуктът вече е наличен във

                  <strong className="text-emerald-700">
                    {' '}физически аптеки, дрогерии и специализирани магазини в страната.
                  </strong>
                ...
                <a
                  ...
                  aria-label="Виж физическите обекти"
                  className="flex items-center justify-center sm:justify-end gap-0.5 flex-shrink-0 px-2 py-1 group"
                >

                  {[0, 1, 2, 3, 4].map((i) => (
                    <span
                      key={i}
                      className="physical-arrow inline-block text-2xl md:text-3xl font-black text-emerald-600"
                      style={{
              ...
              <style
                dangerouslySetInnerHTML={{
                  __html: `
                    ...
                    .physical-arrow {
                      animation: physicalArrowPulse 1.1s ease-in-out infinite;
                    }
                  `,
                }}
              />
        ...
        <div className="reveal opacity-0 bg-gradient-to-r from-emerald-600 to-teal-600 rounded-2xl md:rounded-3xl p-6 md:p-10 text-white">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-center mt-6 md:mt-8 text-emerald-100 text-sm md:text-base">
              <strong>
                Едно шише (50ml) стига за около 20 дни!
              </strong>
            </p>
