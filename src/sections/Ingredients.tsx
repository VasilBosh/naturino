...
export function Ingredients() {
  ...
  const herbs = [
    ...
    { name: 'Арония', benefit: 'Аронията е богата на естествени антиоксиданти, които подпомагат здравето отвътре', color: 'bg-indigo-100 text-indigo-700' },
    { name: 'Шипка', benefit: 'Шипката е богата на витамин C – повишава устойчивостта към болести', color: 'bg-red-100 text-red-700' },
    { name: 'Мащерка', benefit: 'Мащерката подкрепя дихателната система и предпазва от външни агресори', color: 'bg-emerald-100 text-emerald-700' },
    { name: 'Риган', benefit: 'Ригана е с антибактериално действие – подкрепя имунната система в борбата срещу инфекции', color: 'bg-green-100 text-green-700' },
    { name: 'Салвия', benefit: 'Салвията притежава мощни антибактериални, антиоксидантни и противовъзпалителни свойства', color: 'bg-teal-100 text-teal-700' },
    { name: 'Лайка', benefit: 'Лайката подпомага възстановяването – има меко противовъзпалително действие', color: 'bg-amber-100 text-amber-700' },
    { name: 'Бял равнец', benefit: 'Белия равнец балансира имунния отговор и подпомага детоксикацията.', color: 'bg-orange-100 text-orange-700' },
    { name: 'Джинджифил', benefit: 'Джинджифила подпомага имунната устойчивост при сезонни вируси', color: 'bg-orange-100 text-orange-800' },
  ];
