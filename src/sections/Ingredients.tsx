...
export function Ingredients() {
  ...
  const herbs = [
    { name: 'Планински лимон', benefit: 'Богат на витамин C и антиоксиданти, подпомага клетъчната защита', color: 'bg-yellow-100 text-yellow-700' },
    { name: 'Черен бъз', benefit: 'Антивирусен ефект, подкрепя дихателната система', color: 'bg-purple-100 text-purple-700' },
    { name: 'Арония', benefit: 'Засилва имунитета, подобрява кръвообращението', color: 'bg-indigo-100 text-indigo-700' },
    { name: 'Шипка', benefit: 'Естествен витамин C, укрепва организма', color: 'bg-red-100 text-red-700' },
    { name: 'Мащерка', benefit: 'Антисептични и противовъзпалителни свойства', color: 'bg-emerald-100 text-emerald-700' },
    { name: 'Риган', benefit: 'Антисептични и противовъзпалителни свойства', color: 'bg-green-100 text-green-700' },
    { name: 'Салвия', benefit: 'Антисептични и противовъзпалителни свойства', color: 'bg-teal-100 text-teal-700' },
    { name: 'Лайка', benefit: 'Успокоява стомаха и нервната система', color: 'bg-amber-100 text-amber-700' },
    { name: 'Бял равнец', benefit: 'Успокоява стомаха и нервната система', color: 'bg-orange-100 text-orange-700' },
    { name: 'Джинджифил', benefit: 'Затопля, стимулира кръвообращението', color: 'bg-orange-100 text-orange-800' },
  ];
