...
export function FAQ() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Препоръчителната доза е 25 капки (1.2ml), два пъти дневно - сутрин и вечер. Може да се разтвори в малко вода, сок или хладък чай. Ако детето проявява първи симптоми се увеличва приема трипъти на ден по 25 капки - сутрин, обед и вечер. Поради 100% естествения си състав няма опасност от предозиране!',
    },
    {
    ...
    },
    {
      ...
      answer: 'Повечето родители забелязват подобрение в имунитета и състоянието на детето още първата седмица на редовен прием. За оптимални резултати и спиране цикъла на боледуване, препоръчваме да се приемат целогодишно. Поради естествения си състав, продуктът може да се приема дългосрочно без опасност от привикване или странични ефекти.',
    },
    {
    ...
    
    {
      ...
      answer: (
        <>
          <span>
            Можете да поръчате Naturino Kids директно от този сайт с доставка до ваш адрес или офис на куриер.
            Продуктът вече се предлага и във физически аптеки, дрогерии и специализирани магазини —{' '}
            <strong>11 обекта в 5 града.</strong>
          </span>

          <a
            href="#physical-stores"
            className="inline-flex items-center ml-2 mt-2 sm:mt-0 px-3 py-1.5 rounded-full bg-emerald-100 hover:bg-emerald-200 text-emerald-700 font-bold text-xs transition-colors"
          >
            📍 Виж къде →
          </a>
        </>
    ...
    
    {
      ...
      answer: 'Едно шише от 50ml е достатъчно за около 20 дни прием при препоръчителната дозировка. След отваряне,ако е прекалено топло в помещението - съхранявайте в хладилник.',
    },
  ];
