...
export function FAQ() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Можете да поръчате Naturino Kids директно от този сайт с доставка до ваш адрес или офис на куриер. Продуктът вече се предлага и във физически аптеки, дрогерии и специализирани магазини — 8 обекта в 4 града, а от ноември и в Пловдив, с което партньорската ни мрежа става 9 обекта в 5 града.',
    },
    {
