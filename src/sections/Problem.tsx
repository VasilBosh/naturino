      ...
      <div className="container-custom">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10 md:mb-16">
          ...
          <p className="reveal opacity-0 text-base md:text-lg text-slate-600 leading-relaxed">
            Это реалността за хиляди български семейства. Всяка сутрин се молите детето да е здраво, 
        ...
        <div className="reveal opacity-0 bg-gradient-to-r from-emerald-50 to-teal-50 rounded-2xl md:rounded-3xl p-6 md:p-10 lg:p-12">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="mt-6 flex items-center justify-center gap-3">
              <div className="w-10 h-10 md:w-12 md:h-12 bg-emerald-600 rounded-full flex items-center justify-center text-white font-bold text-sm md:text-base">
                НК
              </div>
